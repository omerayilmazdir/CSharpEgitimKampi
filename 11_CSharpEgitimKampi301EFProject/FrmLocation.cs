...
namespace CSharpEgitimKampi301EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        {
            // Location tablosu üzerinden bir parametre türettik
            Location location = new Location();
            location.Capacity = byte.Parse(txtCapacity.Value.ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            updatedValue.Capacity = byte.Parse(txtCapacity.Value.ToString());
